...
#define Vec2_GetAngleDegrees				GetOrientationDegrees
#define Vec2_GetAngleRadians				GetOrientationRadians
...
#define Vec2_SetAngleDegrees				SetOrientationDegrees
#define Vec2_SetAngleRadians				SetOrientationRadians
...
#define Function_TransformVertexPCUArrayXY	TransformVertexArrayXY3D
