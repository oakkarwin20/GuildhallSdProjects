...
//	{
//		m_angularVelocity.m_rollDegrees -= orientationPerFrame.m_rollDegrees * deltaSeconds;
//	}
...
//	}
	...
	// Elevate
	if ( g_theInput->IsKeyDown( 'E' ) || controller.GetButton(LEFT_SHOULDER).m_isPressed  )
	{
		m_position.z += ( m_speed * deltaSeconds );
	}

	// De-Elevate
	if ( g_theInput->IsKeyDown( 'Q' ) || controller.GetButton(RIGHT_SHOULDER).m_isPressed )
	{
		m_position.z -= ( m_speed * deltaSeconds );
	}
