...
Shader*					g_litShader_PCUTBN	= nullptr; 
...
void App::Startup()
{
	...
	windowConfig.m_windowTitle	= "Inverse Kinematics for Procedural Animations";
...
//	m_theGame->StartUp();
	...
	m_texture_Skybox		= g_theRenderer->CreateOrGetTextureFromFile( "Data/Images/Skybox.png" );
	m_texture_Basketball	= g_theRenderer->CreateOrGetTextureFromFile( "Data/Images/Basketball.png" );
	m_texture_Stars			= g_theRenderer->CreateOrGetTextureFromFile( "Data/Images/Stars.png" );
	m_texture_Brick			= g_theRenderer->CreateOrGetTextureFromFile( "Data/Images/Brick.png" );
	...
	g_theDevConsole->AddLine( Rgba8::GREEN, "IJKL   - Move target position"			   );	
	g_theDevConsole->AddLine( Rgba8::GREEN, "P      - Pause Game"					   );	
	g_theDevConsole->AddLine( Rgba8::GREEN, "Escape - Exit Game"					   );	

	//----------------------------------------------------------------------------------------------------------------------
	// Init shader for lighting
	//----------------------------------------------------------------------------------------------------------------------
	g_litShader_PCUTBN = g_theRenderer->CreateOrGetShaderByName( "Data/Shaders/SpriteLit", VertexType::VERTEX_PCUTBN );
}
...
{ 
	if ( m_turnAttractModeOffNextFrame )
	{
		m_attractModeIsOn = false;
		m_turnAttractModeOffNextFrame = false;
	}
...
void App::Render() const
{
	...
	if ( !m_attractModeIsOn )
	{
		g_theRenderer->ClearScreen( Rgba8::SKYBLUE );
...
void App::UpdateReturnToAttractMode()
{
	...
	{
//		m_turnAttractModeOffNextFrame = true;
...
void App::AttractModeInput()
{
	...
	{
		g_gameModeNum					= EULER_FROM_VECTOR_VISUAL_TEST_3D;
		m_theGameMode					= GameModeBase::CreateNewGameOfType( g_gameModeNum );
		m_turnAttractModeOffNextFrame	= true;
		m_theGameMode->Startup();
	}
	...
	{
		g_gameModeNum					= FABRIK_FWD_ONLY_3D;
		m_theGameMode					= GameModeBase::CreateNewGameOfType( g_gameModeNum );
		m_turnAttractModeOffNextFrame 	= true;
		m_theGameMode->Startup();
	}
...
//	AddVertsForAABB2D( textVerts, backgroundBounds, Rgba8::DARK_RED );
	...
	// Version without the robotA
	m_textFont->AddVertsForTextInBox2D( textVerts, box, 15.0f,
	"1: Skeletal PlayGround 2D\n\n2: Skeletal PlayGround 3D\n\n3: 2BoneIK TestMode 3D\n\n4: CCD TestMode 3D\n\n5: FABRIK TestMode 3D\n\n6: Quadruped TestMode 3D\n\n7: Spider TestMode 3D\n\n8: Euler TestMode 3D\n\n9: FABRIK Fwd Only TestMode 3D\n\n0: Robot Arm TestMode 3D\n\nQ: Animations", 
	Rgba8::WHITE, 1.0f, Vec2(0.5f, 0.5f) );


	// Version with robot and FABRIK fwd only test mode
//	m_textFont->AddVertsForTextInBox2D( textVerts, box, 15.0f,
//	"1: Skeletal PlayGround 2D\n\n2: Skeletal PlayGround 3D\n\n3: 2BoneIK TestMode 3D\n\n4: CCD TestMode 3D\n\n5: FABRIK TestMode 3D\n\n6: Quadruped Creature TestMode 3D\n\n7: Spider TestMode 3D\n\n8: Euler TestMode 3D\n\n9: FABRIK Fwd Only TestMode 3D\n\n0: Robot Arm TestMode 3D", 
//	Rgba8::WHITE, 1.0f, Vec2(0.5f, 0.5f) );
