...
//	FbxFileImporter::LoadAnimationPose( "Data/Animations/TPose.fbx", m_bindAnimationPose );
	...
	// 0 keyframe
	FbxFileImporter::LoadCurveForAllJointsAtElapsedTime( "Data/Animations/Run.fbx", m_newAnimationPose, m_bindAnimationPose, m_elapsedAnimationTime );
...
{	
	...
	AnimationPose newAnimPose;
	if ( m_totalTimeMS > m_animationClip.m_endTime )
	{
		m_totalTimeMS = 0.0f;
	}
	newAnimPose = m_animationClip.SampleAnimPoseAtTime( m_totalTimeMS, m_bindAnimationPose, true );
	for ( int jointId = 0; jointId < newAnimPose.m_jointList.size(); jointId++ )
	{
		AnimationJoint const& joint = newAnimPose.m_jointList[jointId];
		Transform const& curJointTransform = newAnimPose.LocalToModel_Transform(jointId);
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_Animations::UpdateGameMode3DCamera()
{
	//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_Animations::UpdateCreature( float deltaSeconds )
{
	// Debug single step
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_Animations::RenderCreature( std::vector<Vertex_PCU>& verts, 
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_Animations::InitializeCreatures()
{
	//----------------------------------------------------------------------------------------------------------------------
	// Creature
	//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_Animations::SetChainConstraints()
{	
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_Animations::UpdateCameraAndCreatureInput( float deltaSeconds )
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_Animations::UpdatePoleVector()
{
