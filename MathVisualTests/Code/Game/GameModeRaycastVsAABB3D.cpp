...
//----------------------------------------------------------------------------------------------------------------------
GameModeRaycastVsAABB3D::GameModeRaycastVsAABB3D()
{
}
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::Startup()
{
	// Initializing textures;
	m_testTexture = g_theRenderer->CreateOrGetTextureFromFile( "Data/Images/Test_StbiFlippedAndOpenGL.png" );

	m_bounds->SetCenterXYZ( Vec3( 10.0f, 0.0f, 0.0f ) );

	m_aabb3List.push_back( m_bounds );

	for ( int i = 0; i < m_numBoxes; i++ )
	{
		AABB3* box = new AABB3( Vec3( 0.0f, 0.0f, 0.0f ), Vec3( 10.0f, 10.0f, 10.0f ) );
		...
		box->SetCenterXYZ( Vec3( randX, randY, randZ ) );
		m_aabb3List.push_back( box );
	}
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::Update( float deltaSeconds )
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::Render() const
{
	//----------------------------------------------------------------------------------------------------------------------
	// Begin Camera
	...
	g_theApp->m_textFont->AddVertsForText3D( textVerts, textOrigin, iBasis, jBasis, 5.0f, "GameModeRaycastVsAABB3D!", Rgba8::GREEN );

	//----------------------------------------------------------------------------------------------------------------------
	// Render Quad
	for ( int i = 0; i < m_aabb3List.size(); i++ )
	{
		AddVertsForAABB3D( texturedVerts, *m_aabb3List[i] );
	}
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::Reshuffle() 
{
	//----------------------------------------------------------------------------------------------------------------------
	// Object variables
	// Quad
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::Shutdown()
{
}

//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::UpdateGameCameraTestShapes3D()
{
	m_testShapesWorldCamera.SetPerspectiveView( 2.0f, 60.0f, 0.1f, 1000.0f  );
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::UpdateInputForCameraMovement( float deltaSeconds)
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::RenderUIStuff() const
{
	//----------------------------------------------------------------------------------------------------------------------
	// Begin UI Camera
	...
	g_theApp->m_textFont->AddVertsForTextInBox2D( textVerts, textbox1, cellHeight, "Mode (F6/F7 for prev/next): Raycast Vs AABB 3D (3D)", Rgba8::YELLOW, 0.75f, Vec2( 0.0f, 1.0f ), TextDrawMode::SHRINK_TO_FIT );
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::UpdatePauseQuitAndSlowMo()
{
	// Pause functionality
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::AddVertsForCompass( std::vector<Vertex_PCU>& compassVerts, Vec3 startPosition, float axisLength, float axisThickness ) const
{
	//----------------------------------------------------------------------------------------------------------------------
	// Render stationary world compass
	// X
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::UpdateRaycastResult3D()
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameModeRaycastVsAABB3D::MoveRaycastInput( float deltaSeconds )
{
